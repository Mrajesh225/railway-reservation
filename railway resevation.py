...
class train:
    def __init__(self,name = '', num = 0, arr_time = '',dep_time = '',arv = '' ,dep = '',day_of_travel = '',seat_available_in_1AC = 0,seat_available_in_2AC = 0,seat_available_in_SL = 0,fare_1ac = 0, fare_2ac = 0 ,fare_sl = 0):
        self.name = name
        self.num = num
...
t1 = train('koromendal',14789,'03:34','14:12','hyd','ods','sat',30,23,43,2205,320,234)
t2 = train('padmavathi',12565,'11:44','01:12','vij','trp','Mon',33,4,12,3434,435,234)
t3 = train('krishna',12313,'01:56','22:45','vzg','hyd','thu',33,24,77,455,325,533)
trains = {t1.num:t1,t2.num:t2,t3.num:t3}
u1 = user(1111,'pooja','vijayawada','7478021777','pooja')
u2 = user(2322,'mukesh','tirupati','7873752967','tirupati')
